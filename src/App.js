    ...
    <div className="app">
      ...
      <section>
        ...
        <ul>
          <li>
            <h3>College</h3>
            <p>Sally's College Mineapolis, MN</p>
          </li>
        </ul>
      </section>
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              company name, job title, dates of employment, and a short
              description of the job (for this last bit, feel free to use lorem
              ipsum filler text).
            </p>
          </li>
          <li>
            ...
            <p lang="es">
              Este parrafo solo es un aprueba de lectura en lenguaje diferente.
            </p>
          </li>
        </ul>
      </section>
